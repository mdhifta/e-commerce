...
function transfer($bukti_bayar, $alamat){
  global $mysqli;
      ...
      foreach($_SESSION['cart'] as $product_id => $quantity) {
        ...
        if($result){
          ...
          if($obj = $result->fetch_object()) {
            ...
            //$query = $mysqli->query("INSERT INTO orders (product_code, product_name, price, units, total, bukti_bayar, pembeli, alamat, status) VALUES('$obj->product_code', '$obj->product_name', '$obj->product_desc', $obj->price, $quantity, $cost,'$bukti_bayar',  '$user', '$alamat', '$status')");
            $query = $mysqli->query("INSERT INTO pembayaran (user, product_code, product_name, units, total, bukti_bayar, alamat, status) VALUES('$user', '$obj->product_code', '$obj->product_name', '$quantity', '$cost', '$bukti_bayar', '$alamat', '$status' )");
