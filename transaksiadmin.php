              ...
              <table class="table" method="post">
                  ...
                  <tbody>
                    <?php
                      ...
                      $result = $mysqli->query('SELECT * FROM pembayaran');
                      if($result === FALSE){
                        die(mysql_error());
                      }
                      ...
                      if($result){
                          ...
                          while($obj = $result->fetch_object()) {
                            ...
                            echo "<tr>
                                    ...
                                    <td><img style='width:100px;' src='bukti_transfer/".$obj->bukti_bayar."'/></td>
                                    <td>".$obj->status."</td>
                                    <td><a href='edit.php?id=".$obj->id."' class='btn btn-info'>Edit</a>
                                    <a href='hapus.php?id=".$obj->id."' class='btn btn-danger'>Hapus</a>
                                    </td>
                                    </tr>";
