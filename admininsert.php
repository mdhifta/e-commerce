...
<?php
  ...
  if(isset($_POST['submit'])){
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
        if($ukuran < 3044070){
            if(tambahdata($product_code, $product_name, $product_desc, $product_img_name, $qty, $price)){
              move_uploaded_file($file_tmp, 'file/'.$product_img_name);
      }
    }
  }
}
      ...
      <div class="logo"  style="background-color:white;border:2px;border-style:solid;border-color:white;border-bottom-color:#F9F9F9;">
		...
		<div class="page-container2">
            ...
            <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
             ...
             <div class="inputdata" style="margin-top:90px;margin-left:310px;">
               <h2>Masukkan data barang baru</h2>
               <form method="POST" action="" enctype="multipart/form-data">
                   <input type="text" id="right-label" placeholder="Kode Produk" name="product_code" class="form__field">
                   <input type="text" id="right-label" placeholder="Nama Produk" name="product_name" class="form__field">
                   <input type="text" id="right-label" placeholder="Tentang Produk" name="product_desc" class="form__field">
                   <input type="text" id="right-label" placeholder="Banyak Produk" name="qty"class="form__field">
                   <input type="text" id="right-label" placeholder="Harga Produk" name="price"class="form__field">
                   <input type="file" id="right-label" name="file">
                 <button style="margin-left:350px;" name="submit" class="uplod">Upload</button>
             </form>
            </div>
