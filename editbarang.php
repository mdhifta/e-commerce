...
<?php
  if(isset($_POST['submit'])){
    ...
    $data =$_POST["banyak"];
    $product_desc = $_POST["decs_product"];
    $price = $_POST["harga"];

    if($product_code!=""){
      $result = $mysqli->query('UPDATE products SET product_code ="'. $product_code.'" WHERE id ='.$id);
    ...
    if($data!=""){
      $newqty = $tmp+$data;
      $result = $mysqli->query('UPDATE products SET qty ="'.$newqty.'" WHERE id ='.$id);
      header("location:admin.php");
      if($result){
      }
    }
	...
	<div class="page-wrapper">
      ...
      <div class="logo"  style="background-color:white;border:2px;border-style:solid;border-color:white;border-bottom-color:#F9F9F9;">
		...
		<div class="page-container2">
            ...
            <h1 style="margin-top:150px;margin-left:390px;">Ubah Product</h1>
            <br>
          <div class="editbar" style="margin-left:420px;">
            <form method="POST" class="test"  style="margin-top:10px;margin-left:10px;">
              <div class="row">
                <div class="small-12">

                  <div class="row">
                    <div class="small-3 columns">
                      <label for="right-label" class="right inline">Kode Produk</label>
                    </div>
                  ...
                  <?php
                      ...
                      if($result){
                        $obj = $result->fetch_object();
                          echo '<input type="text" id="right-label" placeholder="'. $obj->product_code. '" name="code_product">';
                          ...
                          echo '<label for="right-label" class="right inline">Nama Produk</label>';
                          echo '</div>';
                          echo '<div class="small-8 columns end">';

                          echo '<input type="text" id="right-label" placeholder="'. $obj->product_name. '" name="name_product">';
                          ...
                          echo '<div class="row">';
                          echo '<div class="small-3 columns">';
                          echo '<label for="right-label" class="right inline">Banyak</label>';
                          echo '</div>';
                          echo '<div class="small-8 columns end">';
                          echo '<input type="text" id="right-label" placeholder="'. $obj->qty. '" name="banyak">';
                          ...
                          echo '<div class="row">';
                          echo '<div class="small-3 columns">';
                          echo '<label for="right-label" class="right inline">Tentang Produk</label>';
                          echo '</div>';
                          echo '<div class="small-8 columns end">';
                          echo '<input type="text" id="right-label" placeholder="'. $obj->product_desc. '" name="decs_product">';
                          echo '</div>';
                          echo '</div>';

                          echo '<div class="row">';
                          echo '<div class="small-3 columns">';
                          echo '<label for="right-label" class="right inline">Harga</label>';
                          echo '</div>';
                          echo '<div class="small-8 columns end">';

                          echo '<input type="text" id="right-label" placeholder="'. $obj->price. '" name="harga">';
                    ...
                    <br>
                      <div class="small-8 columns" style="margin-left:500px;">
                        <input type="submit" name="submit" id="right-label" value="Ubah" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
