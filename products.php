        ...
        <?php
          ...
          if($result){
            ...
            while($obj = $result->fetch_object()) {
              ...
              if($obj->qty > 0){
                echo '<p><a href="update-cart.php?action=add&id='.$obj->id.'"><input type="submit" value="Tambah Ke Keranjang" style="clear:both; background:#2CBBBB;border:none;border-radius: 5px; color: #fff; font-size: 1em; padding:10px;margin-left:1px;" /></a></p>';
              }
              else {
                echo 'Stock Habis!';
              }
